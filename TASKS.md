...
- [x] Strategic Memory narrative rewrite (founder briefing, July 2026): category claimed in hero eyebrow + footer ("the strategic memory layer for enterprise"), concept defined + owned in the flywheel section (new `hiw.intro` region; h2 "Sessions are how you use it. The memory is what you own."), memory language threaded through hero subtitle, session body, problem body/card3, flywheel steps 2+5, caption; meta descriptions updated. Locked blocks (H1, Paul's formula) untouched. Verified via Playwright at 375/768/1280/1600 — no overflow, scroll-jack + flywheel auto-cycle intact.
